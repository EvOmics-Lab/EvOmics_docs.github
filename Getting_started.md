...
General information of the Lab: 
...
Values: QGG and our lab welcomes people with different backgrounds from all over the world. For that, the values we encourage are respect, collaboration, inclusivity, and communication. Please feel free to come to talk with me or HR if you have any problems at the workplace. 
...
Reboot you laptop and press ESC, F1, F2, F8 or F10 to access the BIOS settings. Change the booting option to start with USB 
...
Rember if you selected double boot, when you access Windows, you will be asked to insert the BitLocker key (I still haven’t figured out how to turn it off O_O). 
...
When requesting the user, state that you are a PhD student, or a postdoc at my group and need access to work on some projects. 
